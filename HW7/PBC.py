...
hdul.writeto('0.005s_PSF_2000x2000.fits',overwrite=True)

hdu = fits.PrimaryHDU(PSF(exptime=0.05, image= image1, I=I))
hdul = fits.HDUList([hdu])
hdul.writeto('0.05s_PSF_2000x2000.fits',overwrite=True)

hdu = fits.PrimaryHDU(PSF(exptime=0.5, image= image1, I=I))
hdul = fits.HDUList([hdu])
hdul.writeto('0.5s_PSF_2000x2000.fits',overwrite=True)

hdu = fits.PrimaryHDU(PSF(exptime=5, image= image1, I=I))
hdul = fits.HDUList([hdu])
hdul.writeto('5s_PSF_2000x2000.fits',overwrite=True)
