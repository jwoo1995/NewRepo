...
tic= timer()
# ============== 01. make coordinate =======================
d1 = 0.02 * 10 ** -3 * u.m  # diameter of aperture
d1 = d1.value
d2 = 0.1 * 10 ** -3
f = 20 * 10 ** -3 * u.m
...
center_pupil_x = (x_prime[0] + x_prime[-1]) / 2
x_prime = x_prime - center_pupil_x

y_prime = np.linspace(1, 100, 100, endpoint=True)  # coordinate of aperture
y_prime = y_prime * 1 / 100 * d2  # physical length

center_pupil_y = (y_prime[0] + y_prime[-1]) / 2
y_prime = y_prime - center_pupil_y
